...
public abstract class EjbTestCase {
    ...
    protected <T> T lookupBy(Class<T> type) throws NamingException {
        // jndi name choas between glassfish and tomee !
        T instance;
        try {
            instance = (T) namingContext.lookup("java:global/classes/" + type.getSimpleName());
        } catch(NamingException e) {
            instance = (T) namingContext.lookup("java:global/EJBModuleMaven/" + type.getSimpleName());
        }
        return instance;
    }
